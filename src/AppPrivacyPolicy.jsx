...
function AppPrivacyPolicy() {
  ...
  return (
    <div className="p-3">
      ...
      <div style={styles.subHeader}>1.Introduction</div>
      ...
      <div style={styles.subHeader}>Information Storage and Security</div>
      <div style={styles.listItem}>
      ...
      <div style={styles.subHeader}>Legal Disclosure</div>
      ...
      <div style={styles.subHeader}>I. Information Storage and Security</div>
      <div style={styles.listItem}>
        We store and process your information, including any sensitive financial
        information (as defined under the Information Technology Act, 2000), on
        secure computers protected by both physical and technological security
      ...
      <div style={styles.subHeader}>II. Business Transactions</div>
      <div style={styles.listItem}>
      ...
      <div style={styles.subHeader}>2. Information We Collect</div>
      <div style={styles.listItem}>
        <div style={styles.bold}> Personal Information:</div> We may collect
      ...
      <div style={styles.listItem}>
        <div style={styles.bold}> Non-Personal Information:</div> We may also
      ...
      <div style={styles.subHeader}>3. How We Use Your Information</div>
      <div style={styles.listItem}>
      ...
      <div style={styles.subHeader}>4. Disclosure of Your Information</div>
      <div style={styles.listItem}>
      ...
      <div style={styles.listItem}>
        <div style={styles.bold}> Service Providers:</div> We may share your
      ...
      <div style={styles.listItem}>
        <div style={styles.bold}> Legal Requirements:</div> We may disclose your
        information if required to do so by law or in response to valid requests
        by public authorities.
      </div>
      <div style={styles.subHeader}>5. Security of Your Information</div>
      <div style={styles.listItem}>
      ...
      <div style={styles.subHeader}>6. Your Rights</div>
      <div style={styles.listItem}>You have the right to:</div>
      <div style={styles.listItem}>
      ...
      <div style={styles.subHeader}>7. Cookies and Tracking Technologies</div>
      <div style={styles.listItem}>
      ...
      <div style={styles.subHeader}>8. Third-Party Links</div>
      <div style={styles.listItem}>
      ...
      <div style={styles.subHeader}>9. Changes to This Privacy Policy</div>
      <div style={styles.listItem}>
      ...
      <div style={styles.subHeader}>10. Contact Us</div>
      <div style={styles.listItem}>
        If you have any questions about this <b>PRIVACY POLICY,</b> please
        contact us at:
      </div>
      <div style={styles.listItem}>
        <b>Mobile:</b> +91 9743888803
      </div>
      <div style={styles.listItem}>
        <b>Email:</b> [support@nithyaevent.com]
      </div>
      <div style={styles.listItem}>
      ...
      <div style={styles.listItem}>No : 34. Venkatappa Road Tasker Town</div>
      <div style={styles.listItem}>Off Queens Road Bangalore 560051</div>
    </div>
  );
}
